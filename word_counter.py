...
plt.title("Word Frequency", fontsize=24, fontweight='bold', pad=15)
plt.xlabel("Word", fontsize=20, fontweight='bold', labelpad=15)
plt.ylabel("Count", fontsize=20, fontweight='bold', labelpad=15)
plt.tight_layout()
plt.show()